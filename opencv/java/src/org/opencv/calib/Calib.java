...
public class Calib {
    ...
    //
    // C++:  double cv::calibrateMultiview(vector_Mat objPoints, vector_vector_Mat imagePoints, vector_Size imageSize, Mat detectionMask, Mat models, vector_Mat& Ks, vector_Mat& distortions, vector_Mat& Rs, vector_Mat& Ts, Mat flagsForIntrinsics = Mat(), int flags = 0)
    //
