...
public class Core {
    ...
    private static String getVersion() { return "5.0.0alpha"; }
    ...
    private static String getVersionStatusJ() { return "alpha"; }
     ...
     * <b>Note:</b> CV_16F/CV_16BF/CV_Bool/CV_64U/CV_64S/CV_32U are not supported for lut.
