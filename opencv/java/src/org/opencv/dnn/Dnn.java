...
public class Dnn {
    ...
    //
    // C++:  Net cv::dnn::readNetFromCaffe(String prototxt, String caffeModel = String(), int engine = ENGINE_AUTO)
    //
     ...
     * @return Net object.
     */
    public static Net readNetFromCaffe(String prototxt, String caffeModel, int engine) {
        return new Net(readNetFromCaffe_0(prototxt, caffeModel, engine));
    }
    ...
    public static Net readNetFromCaffe(String prototxt, String caffeModel) {
        return new Net(readNetFromCaffe_1(prototxt, caffeModel));
    }
    ...
    public static Net readNetFromCaffe(String prototxt) {
        return new Net(readNetFromCaffe_2(prototxt));
    }


    //
    // C++:  Net cv::dnn::readNetFromCaffe(vector_uchar bufferProto, vector_uchar bufferModel = std::vector<uchar>(), int engine = ENGINE_AUTO)
    //
    ...
    public static Net readNetFromCaffe(MatOfByte bufferProto, MatOfByte bufferModel, int engine) {
        ...
        Mat bufferModel_mat = bufferModel;
        return new Net(readNetFromCaffe_3(bufferProto_mat.nativeObj, bufferModel_mat.nativeObj, engine));
    }
    ...
    public static Net readNetFromCaffe(MatOfByte bufferProto, MatOfByte bufferModel) {
        Mat bufferProto_mat = bufferProto;
        Mat bufferModel_mat = bufferModel;
        return new Net(readNetFromCaffe_4(bufferProto_mat.nativeObj, bufferModel_mat.nativeObj));
    }
    ...
    public static Net readNetFromCaffe(MatOfByte bufferProto) {
        Mat bufferProto_mat = bufferProto;
        return new Net(readNetFromCaffe_5(bufferProto_mat.nativeObj));
    }
     ...
     * or REF: readNetFromDarknet. An order of {@code model} and {@code config}
    ...
    // C++:  Net cv::dnn::readNetFromCaffe(String prototxt, String caffeModel = String(), int engine = ENGINE_AUTO)
    private static native long readNetFromCaffe_0(String prototxt, String caffeModel, int engine);
    private static native long readNetFromCaffe_1(String prototxt, String caffeModel);
    private static native long readNetFromCaffe_2(String prototxt);

    // C++:  Net cv::dnn::readNetFromCaffe(vector_uchar bufferProto, vector_uchar bufferModel = std::vector<uchar>(), int engine = ENGINE_AUTO)
    private static native long readNetFromCaffe_3(long bufferProto_mat_nativeObj, long bufferModel_mat_nativeObj, int engine);
    private static native long readNetFromCaffe_4(long bufferProto_mat_nativeObj, long bufferModel_mat_nativeObj);
    private static native long readNetFromCaffe_5(long bufferProto_mat_nativeObj);
